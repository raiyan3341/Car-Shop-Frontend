        ...
        <footer className="bg-gray-800 text-white p-10 mt-10">
            <div className="container mx-auto">
                <div className="footer grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-8">
                    <nav>
                        <header className="footer-title text-xl font-bold text-primary">🚗 CarRentalsPro</header>
                        <p className="text-gray-400 mt-2"> Your trusted partner for hassle-free car rentals.</p>
                    </nav>
                    <nav>
                        <header className="footer-title">Contact Info</header>
                        <p className="flex items-center text-gray-400">
                            <FaPhone className="mr-2 text-primary" /> +8801871093089</p>
                        <p className="flex items-center text-gray-400">
                            <FaEnvelope className="mr-2 text-primary" /> rayanbin13@gmail.com</p>
                ...
                <div className="footer-center text-center mt-8 pt-4 border-t border-gray-700">
                    <p className="text-sm text-gray-400"> 
                        &copy; {new Date().getFullYear()} CarRentalsPro. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
